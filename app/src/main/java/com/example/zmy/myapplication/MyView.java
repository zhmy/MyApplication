...
//        }
        ...
        canvas.drawRect(contentWidth/8, 0, contentWidth/8 + 50, 50, paint);
        canvas.drawRect(contentWidth/8 + 50 + 20, 0, contentWidth/8 + 50 + 20 + 50, 50, paint);
        canvas.drawRect(contentWidth/8 + 30, 50 +20, contentWidth/8 + 30 + 60, 50 + 20+ 20, paint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.e("zmy", "MyView onTouchEvent DOWN");
                break;
            case MotionEvent.ACTION_MOVE:
                Log.e("zmy", "MyView onTouchEvent ACTION_MOVE");
                break;
            case MotionEvent.ACTION_UP:
                Log.e("zmy", "MyView onTouchEvent ACTION_UP");
                break;
        }
        return false;
    }
